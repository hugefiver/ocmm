...
This reference is deliberately stack-agnostic. It never tells you which logging library to use — the project's existing practice decides (Rule 0).
...
4. **The stack's standard structured logger** — never a hand-rolled one.
