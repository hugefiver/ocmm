...
| dispatching-parallel-agents | obra/superpowers/dispatching-parallel-agents | v6.0.3 | no content adjustments needed (upstream has no executing-plans/using-git-worktrees/omo references); v1 maintenance header comment added; frontmatter kept as first bytes for OpenCode native slash skill loading | 2026-06-29 |
