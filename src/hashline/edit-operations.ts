import { dedupeEdits } from "./edit-deduplication.ts"
import { collectLineRefs, detectOverlappingRanges, getEditLineNumber } from "./edit-ordering.ts"
import type { HashlineEdit } from "./types.ts"
import {
  applyAppend,
  applyInsertAfter,
  applyInsertBefore,
...
import { validateLineRefs } from "./validation.ts"
