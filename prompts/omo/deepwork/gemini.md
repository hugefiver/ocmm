...
3. **DO** consult specialists only when needed (`hard-reasoning` for genuinely difficult decisions—strict or high-risk conditions alone do not qualify; artistry for non-conventional work)
