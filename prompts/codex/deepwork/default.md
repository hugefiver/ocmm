...
| requesting-code-review | completing a task or major feature, before merge; final acceptance: oracle default (simple), oracle+reviewer (complex) | load skill `deepwork-requesting-code-review` |
